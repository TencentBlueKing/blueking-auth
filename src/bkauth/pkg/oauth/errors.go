...
// NewInvalidRequestError creates an OAuthError with code "invalid_request".
...
// NewInvalidClientError creates an OAuthError with code "invalid_client".
...
// NewInvalidGrantError creates an OAuthError with code "invalid_grant".
...
// NewUnauthorizedClientError creates an OAuthError with code "unauthorized_client".
...
// NewAccessDeniedError creates an OAuthError with code "access_denied".
...
// NewUnsupportedResponseTypeError creates an OAuthError with code "unsupported_response_type".
...
// NewUnsupportedGrantTypeError creates an OAuthError with code "unsupported_grant_type".
...
// NewUnsupportedTokenTypeError creates an OAuthError with code "unsupported_token_type".
...
// NewServerError creates an OAuthError with code "server_error".
func NewServerError(description string) *OAuthError {
	return &OAuthError{Code: ErrorCodeServerError, Description: description}
}

// NewInvalidClientMetadataError creates an OAuthError with code "invalid_client_metadata".
...
// NewInvalidRedirectURIError creates an OAuthError with code "invalid_redirect_uri".
...
// NewAuthorizationPendingError creates an OAuthError with code "authorization_pending".
...
// NewSlowDownError creates an OAuthError with code "slow_down".
func NewSlowDownError(description string) *OAuthError {
	return &OAuthError{Code: ErrorCodeSlowDown, Description: description}
}

// NewExpiredTokenError creates an OAuthError with code "expired_token".
...
// ErrRealmMismatch indicates the realm in the request does not match the token's realm.
