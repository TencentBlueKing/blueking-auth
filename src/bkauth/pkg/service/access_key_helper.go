...
func newDaoAccessKey(appCode, createdSource string) (dao.AccessKey, error) {
...
func newDaoAccessKeyWithAppSecret(appCode, appSecret, createdSource string) (dao.AccessKey, error) {
