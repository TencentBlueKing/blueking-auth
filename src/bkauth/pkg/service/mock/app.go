...
func (mr *MockAppServiceMockRecorder) Create(app, createdSource interface{}) *gomock.Call {
...
func (mr *MockAppServiceMockRecorder) CreateWithSecret(app, appSecret, createdSource interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAppServiceMockRecorder) Exists(code interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockAppServiceMockRecorder) NameExists(name interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
