...
// Package login provides user authentication adapters for various BK login methods.
package login
...
// CookieName returns the cookie name used for bk_ticket authentication.
...
// CheckLogin verifies the bk_ticket and returns the authentication result.
