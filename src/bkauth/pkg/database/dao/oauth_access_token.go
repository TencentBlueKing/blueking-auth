...
// CreateWithTx inserts a new access token record within the given transaction.
...
// GetByTokenHash retrieves an access token by its SHA-256 hash.
...
// RevokeWithTx marks the access token as revoked within the given transaction.
...
// RevokeByGrantIDWithTx revokes all access tokens belonging to the given grant within the transaction.
