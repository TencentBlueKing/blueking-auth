...
func (mr *MockScopeManagerMockRecorder) BulkCreate(scopes any) *gomock.Call {
...
func (mr *MockScopeManagerMockRecorder) BulkDelete(targetID, ids any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockScopeManagerMockRecorder) ListByTargetID(targetID any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
...
func (mr *MockScopeManagerMockRecorder) Update(targetID, scopeID, scope any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
