...
// Create inserts an OAuth authorization code row.
...
// Get loads an authorization code by value; returns a zero value when no row exists.
...
// MarkAsUsed sets used=1 for the code when it is still unused; returns rows affected.
