  ...
  state: () => ({
    env: {
      ...
      DOC_LINKS: {
        ...
        LOADBALANCE: '',
        PLUGIN_AI_PROXY: '',
        PLUGIN_AI_RATE_LIMITING: '',
        PLUGIN_API_BREAKER: '',
        PLUGIN_BK_ACCESS_TOKEN_SOURCE: '',
        PLUGIN_BK_CORS: '',
        PLUGIN_BK_HEADER_REWRITE: '',
        PLUGIN_BK_IP_RESTRICTION: '',
        PLUGIN_BK_MOCK: '',
        PLUGIN_BK_RATE_LIMIT: '',
        PLUGIN_BK_REQUEST_BODY_LIMIT: '',
        PLUGIN_BK_USERNAME_REQUIRED: '',
        PLUGIN_BK_USER_RESTRICTION: '',
        PLUGIN_FAULT_INJECTION: '',
        PLUGIN_PROXY_CACHE: '',
        PLUGIN_REDIRECT: '',
        PLUGIN_REQUEST_VALIDATION: '',
        PLUGIN_RESPONSE_REWRITE: '',
        PLUGIN_URI_BLOCKER: '',
      },
    },
  }),
